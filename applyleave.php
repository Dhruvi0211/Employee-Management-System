...
<html>
<head>
	<title>Apply Leave | Employee Panel | EMPLOYEE ADMINISTRATION SYSTEM</title>
                ...
                <div class="card-body">
                    ...
                    <form action="process/applyleaveprocess.php?id=<?php echo $id?>" method="POST">
                        ...
                        <div class="input-group">
							...
							<select id="reason" name="reason" style="font-size: 16px;">
								<option value="Emergency Leave">Emergency Leave</option>
								<option value="Medical Leave">Medical Leave</option>
								<option value="Relative’s wedding">Relative’s wedding</option>
